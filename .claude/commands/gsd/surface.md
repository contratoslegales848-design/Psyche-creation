...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `/home/user/Psyche-creation/.claude/skills/.gsd-surface.json`
...
```bash
# Claude Code
RUNTIME_CONFIG_DIR=/home/user/Psyche-creation/.claude/skills

# Resolve commandsDir and agentsDir
COMMANDS_DIR=/home/user/Psyche-creation/.claude/commands/gsd
AGENTS_DIR=/home/user/Psyche-creation/.claude/agents
```
...
<execution_context>
Surface state file: `/home/user/Psyche-creation/.claude/skills/.gsd-surface.json`
Install profile marker: `/home/user/Psyche-creation/.claude/skills/.gsd-profile`
Engine module: `/home/user/Psyche-creation/.claude/get-shit-done/bin/lib/surface.cjs`
Cluster definitions: `/home/user/Psyche-creation/.claude/get-shit-done/bin/lib/clusters.cjs`
</execution_context>
