...
```markdown
Read /home/user/Psyche-creation/.claude/agents/gsd-ui-researcher.md for instructions.
...
Template: /home/user/Psyche-creation/.claude/get-shit-done/templates/UI-SPEC.md
</output>
...
```markdown
Read /home/user/Psyche-creation/.claude/agents/gsd-ui-checker.md for instructions.
