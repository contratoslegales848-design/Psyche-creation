...
```bash
INIT=$(node "/home/user/Psyche-creation/.claude/get-shit-done/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "/home/user/Psyche-creation/.claude/get-shit-done/bin/gsd-tools.cjs" commit \
