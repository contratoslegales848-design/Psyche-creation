...
```
Agent(
  prompt="Read /home/user/Psyche-creation/.claude/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/home/user/Psyche-creation/.claude/get-shit-done/templates/VALIDATION.md`
