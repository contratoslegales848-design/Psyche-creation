...
Reference full template: `/home/user/Psyche-creation/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `/home/user/Psyche-creation/.claude/get-shit-done/templates/state.md`.
