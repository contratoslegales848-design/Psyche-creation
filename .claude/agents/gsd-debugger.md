...
<required_reading>
@/home/user/Psyche-creation/.claude/get-shit-done/references/common-bug-patterns.md
</required_reading>
...
@/home/user/Psyche-creation/.claude/get-shit-done/references/debugger-philosophy.md
...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = /home/user/Psyche-creation/.claude
                  → checks /home/user/Psyche-creation/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /home/user/Psyche-creation/.claude/get-shit-done
                  → writes to /home/user/Psyche-creation/.claude/get-shit-done/hooks/
...
@/home/user/Psyche-creation/.claude/get-shit-done/references/thinking-models-debug.md
...
- Read @/home/user/Psyche-creation/.claude/get-shit-done/references/common-bug-patterns.md
