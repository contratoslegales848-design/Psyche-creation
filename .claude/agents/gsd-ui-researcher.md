...
Use template from `/home/user/Psyche-creation/.claude/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `/home/user/Psyche-creation/.claude/get-shit-done/templates/UI-SPEC.md`
