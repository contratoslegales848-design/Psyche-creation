...
| `linkedin-ray-16-poder-facultades-y-limites.json` | 3 | BLOQUEADO | CERRADO — claim 1 (mandato/poder) y claim 3 (reformulación corregida) en APTO_CON_MATICES; claim 2 (formulación original, "el cargo no prueba representación") quedó BLOQUEADO tras investigación societaria real (LGSM/LSC/LGS/CCom): es falso para el cargo de administrador, que sí representa por ley. Un BLOQUEADO frena el agregado de toda la pieza — por diseño. |
