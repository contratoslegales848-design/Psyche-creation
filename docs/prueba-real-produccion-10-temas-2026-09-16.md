...
**Diversidad de arquetipo compositivo (Regla 3, máx. 3/10 del mismo, ver `arquetipo_compositivo.py`):** OK — {'DOCUMENTO_CLOSEUP': 3, 'OBJETO_SOBRE_SUPERFICIE': 2, 'ESCENA_ESCRITORIO': 3, 'SIN_CLASIFICAR': 1, 'PASILLO_ARQUITECTURA_CENTRAL': 1}.
