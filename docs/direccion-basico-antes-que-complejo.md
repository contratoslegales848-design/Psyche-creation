# Dirección de contenido — lo básico transversal antes que lo que se ramifica

**Procedencia:** orden expresa del fundador de 2026-09-03 — «ya no está generando temas
legales y me genera de países en específico; por ahora no, vamos con lo general pero lo legal,
que es muy abierto». Este documento la convierte en regla ejecutable.
**Estado:** vigente · **Implementación:** `content/topics/`

`CLAUDE.md` §2 apuntaba a este archivo desde antes de que existiera. Ese hueco es parte del
problema que corrige: la dirección de contenido vivía en una mención, no en una regla que algo
pudiera comprobar.
